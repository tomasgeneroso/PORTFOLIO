      ...
      <aside className="w-52 flex-shrink-0 bg-[#120D1E] border-r border-[#2D1B3D] flex flex-col">
        <div className="p-4 border-b border-[#2D1B3D]">
          <div className="flex items-center gap-2 mb-3">
            ...
            className={`w-full flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-medium mb-2 transition-colors ${homeMode ? "bg-[#2D1B3D] text-white" : "text-[#9B8BA3] hover:bg-[#2D1B3D]/60 hover:text-gray-200"}`}
          >
