...
My background includes a bachelor's degree in Economics and three years of studies in Information Systems Engineering, as well as courses in UX/UI and backend development. Throughout my career, I have worked in software development, interface design, process optimization and entrepreneurship, gaining experience with SQL, PostgreSQL, MySQL, JavaScript, TypeScript, React, Java, C#, among other technologies.`,
  ...
  skills: [
    {
      icono: <JavascriptIcon size={120} />,
      level: 80,
      color: "blue",
    },
    {
      icono: <ReactIcon size={120} />,
      level: 80,
      color: "red",
    },
    {
      icono: <ExpressIcon size={120} />,
      level: 110,
      color: "red",
    },
    {
      icono: <LaravelIcon size={120} />,
      level: 70,
      color: "red",
    },
    {
      icono: <DockerIcon size={120} />,
      level: 50,
      color: "red",
    },
    {
      icono: <MongoLogo size={120} />,
      level: 110,
      color: "red",
    },
    {
      icono: <ShopifyIcon size={120} />,
      level: 70,
      color: "red",
    },
    {
      icono: <WordpressIcon size={120} />,
      level: 70,
      color: "red",
    },
    {
      icono: <TypeScriptLogo size={120} />,
      level: 70,
      color: "red",
    },
    {
      icono: <PostgreSQLLogo size={120} />,
      level: 70,
      color: "red",
    },
    {
      icono: <TailwindIcon size={120} />,
      level: 80,
      color: "red",
    },
    {
      icono: <PythonLogo size={120} />,
      level: 60,
      color: "red",
    },
    {
    ...
    {
      icono: <Cordova size={130} />,
      level: 40,
      color: "red",
    },
    {
      icono: <CSharpLogo size={130} />,
      level: 40,
      color: "red",
    },
    {
